                        ...
                        <div class="row">
                            <div class="col">
                                <center>
                                    ...
                                    <asp:Label class="badge rounded-pill bg-info text-dark" ID="Label1" runat="server" Text="Label"></asp:Label>
                                </center>
                            </div>
                        </div>
                        <div class="row">
                         ...
                         <div class="row">
                            <div class="col-md-6">
                              ...
                              <div class="col-md-6">
                                   ...
                                   <div class="form-label">
                                       <asp:TextBox CssClass="form-control" ID="TextBox3" runat="server" placeholder="Date of Birth(dd/mm/yyyy)" TextMode="Date"></asp:TextBox>
                                    </div>
                        ...
                        <div class="row">
                            <div class="col-md-4">
                             ...
                             <div class="col-md-4">
                                   ...
                                   <div class="form-label">
                                       <asp:TextBox CssClass="form-control" ID="TextBox10" runat="server" placeholder="NewPassword" TextMode="Password"></asp:TextBox>
                                    </div>
                                ...
                                <center>
                                   ...
                                   <center>
                                     <div class="form-label d-grid gap-2 ">
                                         <asp:Button CssClass="btn btn-primary" ID="Button1" runat="server" Text="Update" OnClick="Button1_Click" />
                                    </div>
                                       </center>
